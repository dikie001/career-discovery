  ...
  const mockupCareers = [
    {
      ...
      illustration: (
        <svg viewBox="0 0 120 90" className="h-24 w-full object-contain">
          ...
          <path
            d="M 35 44 L 45 34 L 55 26 L 65 32"
            fill="none"
            stroke="#F59E0B"
            strokeWidth="2"
            strokeLinecap="round"
          ...
          <path
            d="M 75 52 C 75 46 80 44 85 44 C 90 44 95 46 95 52 Z"
            fill="#CBD5E1"
          />
        </svg>
      ),
    ...
    },
    {
      ...
      illustration: (
        <svg viewBox="0 0 120 90" className="h-24 w-full object-contain">
          ...
          <path
            d="M 60 48 C 55 42 48 42 48 47 C 48 53 60 62 60 62 C 60 62 72 53 72 47 C 72 42 65 42 60 48 Z"
            fill="#EF4444"
          />
          <path
            d="M 45 25 Q 60 18 75 25"
            fill="none"
            stroke="#94A3B8"
            strokeWidth="2.5"
            strokeLinecap="round"
          />
          <path
            d="M 50 25 L 50 35 C 50 42 70 42 70 35 L 70 25"
            fill="none"
            stroke="#94A3B8"
            strokeWidth="2"
          />
    ...
    recommendationCards.length > 0
      ...
      : careers.length > 0
        ? careers.slice(0, 3).map((c, idx) => ({
            ...
            description:
              c.description ||
              mockupCareers[idx % mockupCareers.length].description,
            salary:
              idx === 0
                ? "KSh 120K+ /month"
                : idx === 1
              ...
              activeCareers.map((career) => (
                ...
                >
                  ...
                  <div className="space-y-3">
                    ...
                    {/* SVG illustration */}
                    <div className="flex justify-center rounded-2xl border border-slate-100/50 bg-slate-50/50 py-2">
                      {career.illustration}
                    </div>
